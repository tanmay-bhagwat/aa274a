...
class FrontierExplorer(Node):
    def __init__(self):
        ...
        self.img_sub = self.create_subscription(Bool, "/detector_bool", self.stop_explore, 10)
    ...
    def stop_explore(self, msg: Bool) -> None:
        if msg.data:
            self.image_detected = True
            self.goal_state_pub.publish(self.state)
